...
<!-- 	<div class="container"> -->
		...
		<form action="update_cart.php" method="POST">
			<table class="table table-bordered" align="center" style="width: 100%">
				...
				<tr>
					...
					<td><input type="number" min="1" max="30" name="product[<?php echo $temp; ?>]" value="<?php echo $values['quantity']; ?>" style="width: 50px;"></td>
		...
		<button id="cont_shopping_btn"><a href="index.php" style="text-decoration: none; color: white;">Continue Shopping</a></button>
		<!-- <button><a href="#">Update Cart</a></button>-->
		<button id="checkout_btn"><a href="checkout.php" style="text-decoration: none; color: white;">Proceed to Checkout</a></button>
